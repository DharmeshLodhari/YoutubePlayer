...
class CustomizedTextFormFieldForForeignCurrency extends StatefulWidget {
  ...
  CustomizedTextFormFieldForForeignCurrency({
    super.key,
    this.initialValue,
  ...
  @override
  State<CustomizedTextFormFieldForForeignCurrency> createState() =>
      _CustomizedTextFormFieldForForeignCurrencyState();
}

class _CustomizedTextFormFieldForForeignCurrencyState
    extends State<CustomizedTextFormFieldForForeignCurrency> {
  bool? inputVerified;

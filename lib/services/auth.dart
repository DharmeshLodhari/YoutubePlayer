...
class AuthService {
  ...
  Future<User> createUser(Map<String, dynamic> userData) async {
    ...
    final User _user = User.fromJson(userData);
  ...
  Future<User> authenticate(String? phoneNumber, String? password) async {
    ...
    final uri = AppConfig.baseUrl + "/api/v1/user/auth/get-token/";
    ...
    final Map _body = {"password": password, "phone_number": phoneNumber};
  ...
  Future<Response> httpDelete(String url,
    ...
    await wasTokenBlackListed(response).timeout(
        newTimeOutDuration ?? timeOutDuration,
        onTimeout: () => timeOutFunction());

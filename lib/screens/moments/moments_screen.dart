  ...
  getConnectionMoments() async {
    if (!isContactMomentsLoading) {
      if (nextContactMoments != null && !isContactMomentsLoading) {
        ...
        debugPrint('TEMPLIST -> ${tempList[0].owner}');
        debugPrint('TEMPLIST -> ${tempList[0].mediaPoster}');
    ...
    return Column(
      ...
      children: [
        ...
        contactMomentsList.isEmpty
            ? Text(
                'None of your connections have a moment right now.',
                style: TextStyle(color: blackFont, fontWeight: FontWeight.w700),
              )
            : SizedBox.shrink(),
        SizedBox(
          height: 180,
                ...
                child: Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      SizedBox(height: 3),
                      // Text(
                      //   getTime(widget.userMomentModel.createdAt!),
                      //   style: TextStyle(
                      //     fontSize: 12,
                      //     color: Colors.white,
                      //     fontWeight: FontWeight.w800,

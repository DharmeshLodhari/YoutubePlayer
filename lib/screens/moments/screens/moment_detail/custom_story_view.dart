...
class Shiddo extends StoryItem {
  ...
  /// one passed to the `StoryView`
  factory Shiddo.pageVideo(String url,
      {required StoryController controller,
      Key? key,
      Duration? duration,
      BoxFit imageFit = BoxFit.fitWidth,
  ...
  /// up.
  factory Shiddo.pageProviderImage(ImageProvider image,
      {Key? key,
      BoxFit imageFit = BoxFit.fitWidth,
      String? caption,
      bool shown = false,
  ...
  /// or `NetworkImage`. However, the story continues to play while the image loads
  /// up.
  factory Shiddo.inlineProviderImage(ImageProvider image,
      {Key? key,
      Text? caption,
      bool shown = false,
      bool roundedTop = true,
...
class StoryViewShiddo extends StatefulWidget {
  /// The pages to displayed.
  final List<Shiddo?> storyItems;
  ...
  final ValueChanged<Shiddo>? onStoryShow;

...
class GetVirtualCard extends StatefulWidget {
  @override
  _GetVirtualCardState createState() => _GetVirtualCardState();
}

class _GetVirtualCardState extends State<GetVirtualCard> {

...
import 'package:Slydo/screens/more_apps/yarn/widgets/topic_action_for_comment.dart';
...
class AskCommentView extends StatelessWidget {
  ...
  Widget _buildCommentDescription() {
    return RichTextForTitle(
      description: messageDecoderWithEmoji(commentDetail!.comment ?? '') ?? '',
    );
    // return Text(
  ...
  bool isComments(BuildContext context) {
    DateTime messageCreatedTime =
        DateTime.parse(commentDetail!.createdAt!).toLocal();

...
class ProductCreateAddOn extends StatefulWidget {
  var arguments;

  ProductCreateAddOn({this.arguments, Key? key}) : super(key: key);

  @override
  _ProductCreateAddOnState createState() => _ProductCreateAddOnState();
}

class _ProductCreateAddOnState extends State<ProductCreateAddOn> {

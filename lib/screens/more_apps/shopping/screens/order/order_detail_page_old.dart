...
class OrderDetailPageOld extends StatefulWidget {
  final dynamic arguments;

  const OrderDetailPageOld({super.key, required this.arguments});

  @override
  State<OrderDetailPageOld> createState() => _OrderDetailPageOldState();
}

class _OrderDetailPageOldState extends State<OrderDetailPageOld>

class Bank {
  ...
  Bank(this.slug, this.name);
}

List<Bank> getBanks() {
  return <Bank>[
    Bank('union-bank-of-nigeria-plc', 'Union Bank Of Nigeria Plc'),
    ...
    Bank('first-bank-nigeria-limited', 'First Bank Nigeria Limited'),
    ...
    Bank('united-bank-for-africa-plc', 'United Bank For Africa Plc'),

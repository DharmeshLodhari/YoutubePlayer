...
import 'package:Slydo/screens/more_apps/events/event_explore_screen.dart';
import 'package:Slydo/screens/more_apps/events/my_events_screen.dart';
  ...
  Widget bottomNavigationBar() {
    return Theme(
      ...
      child: BottomNavigationBar(
        ...
        elevation: 10,
        currentIndex: _eventDashboardBloc.index,
        onTap: (index) {
          _eventDashboardBloc.index = index;
        },
        items: [

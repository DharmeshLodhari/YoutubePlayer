...
import 'package:Slydo/screens/messaging/chat/helpers/chat_message_action_handler.dart';
...
import 'package:Slydo/screens/messaging/chat/helpers/message_sound_player.dart';
...
import 'package:Slydo/screens/messaging/chat/tiles/comment_tile_for_chat.dart';
import 'package:Slydo/screens/messaging/chat/tiles/envelope_tile_for_chat.dart';
import 'package:Slydo/screens/messaging/chat/tiles/gif_image_tile_chat.dart';
import 'package:Slydo/screens/messaging/chat/tiles/image_tile_for_chat.dart';
import 'package:Slydo/screens/messaging/chat/tiles/location_tile_for_chat.dart';
import 'package:Slydo/screens/messaging/chat/tiles/moment_tile_for_chat.dart';
import 'package:Slydo/screens/messaging/chat/tiles/product_and_service_tile_for_chat.dart';
import 'package:Slydo/screens/messaging/chat/tiles/product_and_service_tile_for_search.dart';
import 'package:Slydo/screens/messaging/chat/tiles/text_message_render_for_chat_screen.dart';
import 'package:Slydo/screens/messaging/chat/tiles/transaction_tile_for_chat.dart';
import 'package:Slydo/screens/messaging/chat/tiles/user_profile_tile_for_chat.dart';
import 'package:Slydo/screens/messaging/chat/tiles/video_tile_for_chat.dart';
...
class _ChatScreenGroupMessageState extends State<ChatScreenGroupMessage>
  ...
  void handleGroupConversationAdminActions(
  ...
  void handleConversationAction({required Map<String, dynamic> messageData}) {
  ...
  void updateParticipantRights() {
    if (!chatConversation!.mutedParticipants
  ...
  Future<void> recordAudio() async {
    ...
    if (await audioRecorder?.isEncoderSupported(codec) ?? false) {
      ...
      showToast(message: "Not Supported:- $codec");
    }
  }
  ...
  String? getMessageKind({required Map<String, dynamic> messageData}) {
    if (messageData["kind"] == "image") {
      if (messageData['media'].toString().toLowerCase().endsWith(".gif")) {
        return "gif_image";
      }
    }
    return messageData["kind"];
  }

  Map<String, dynamic> modifyMessageAccordingToType(
      {required Map<String, dynamic> messageData}) {
    if (messageData["kind"] == "image") {
      if (messageData['media'].toString().toLowerCase().endsWith(".gif")) {
        messageData["text"] = messageData["media"];
      }
    }
    return messageData;
  }
  ...
  void deleteMessageFromMessageList({required Map<String, dynamic> message}) {
  ...
  void updateEditedMessageInMessageList(
      {required Map<String, dynamic> message}) {

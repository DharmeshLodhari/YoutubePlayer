...
class ProductDetailPageModified extends StatefulWidget {
  var arguments;
  ProductDetailPageModified({@required this.arguments});
  @override
  _ProductDetailPageModifiedState createState() =>
      _ProductDetailPageModifiedState(arguments: arguments);
}

class _ProductDetailPageModifiedState extends State<ProductDetailPageModified>
    with TickerProviderStateMixin {
  var arguments;
  _ProductDetailPageModifiedState({this.arguments});
